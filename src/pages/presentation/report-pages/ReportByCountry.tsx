								...
								<Card>
									<CardHeader className='pb-0'>
										<CardLabel icon='Person' iconColor='success'>
											<CardTitle>Transaction Detailed Report</CardTitle>
										</CardLabel>
									</CardHeader>
									<CardBody>
										...
										<div className='row mt-2'>
											<div className='col-md-3'>
												<FormGroup id='fname' isFloating label='From:'>
													<Input
										...
										<div className='row mt-2'>
											<div className='col-md-3 '>
												<FormGroup id='fname' label='Date From:'>
													<Input
														autoComplete='family-name'
														onChange={formik.handleChange}
														onBlur={formik.handleBlur}
...
export default ReportByCountry;
